...
simsignal_t DfraAgentSTA::sentRequestSignal = registerSignal("sentRequest");
simsignal_t DfraAgentSTA::acceptConfirmSignal = registerSignal("acceptConfirm");
simsignal_t DfraAgentSTA::dropConfirmSignal = registerSignal("dropConfirm");
...
void DfraAgentSTA::handleMessage(cMessage *msg)
{
...
void DfraAgentSTA::handleTimer(cMessage *msg)
{
...
void DfraAgentSTA::handleResponse(cMessage *msg)
{
...
void DfraAgentSTA::receiveSignal(cComponent *source, simsignal_t signalID, cObject *obj DETAILS_ARG)
{
    Enter_Method_Silent();
...
void DfraAgentSTA::sendRequest(Ieee80211PrimRequest *req)
{
...
void DfraAgentSTA::sendScanRequest()
{
...
void DfraAgentSTA::sendAuthenticateRequest(const MACAddress& address)
{
...
void DfraAgentSTA::sendDeauthenticateRequest(const MACAddress& address, int reasonCode)
{
...
void DfraAgentSTA::sendAssociateRequest(const MACAddress& address)
{
...
void DfraAgentSTA::sendReassociateRequest(const MACAddress& address)
{
...
void DfraAgentSTA::sendDisassociateRequest(const MACAddress& address, int reasonCode)
{
...
void DfraAgentSTA::processScanConfirm(Ieee80211Prim_ScanConfirm *resp)
{
    // choose best AP
...
void DfraAgentSTA::dumpAPList(Ieee80211Prim_ScanConfirm *resp)
{
    EV << "Received AP list:\n";
    for (int i = 0; i < (int)resp->getBssListArraySize(); i++) {
...
int DfraAgentSTA::chooseBSS(Ieee80211Prim_ScanConfirm *resp)
{
...
void DfraAgentSTA::processAuthenticateConfirm(Ieee80211Prim_AuthenticateConfirm *resp)
{
...
void DfraAgentSTA::processAssociateConfirm(Ieee80211Prim_AssociateConfirm *resp)
{
    if (resp->getResultCode() != PRC_SUCCESS) {
...
void DfraAgentSTA::processReassociateConfirm(Ieee80211Prim_ReassociateConfirm *resp)
{
