...
#ifndef __DFRAMGMTSTA_H
#define __DFRAMGMTSTA_H
 ...
 * @author Andras Varga
 */
class INET_API DfraMgmtSTA : public Ieee80211MgmtBase, protected cListener //INET_API
{
  public:
    //
